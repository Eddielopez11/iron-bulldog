...
export default React.createClass({
  ...
  leagueAccountSearchHandler(e) {
    ...
    $.getJSON( `https://na.api.pvp.net/api/lol/na/v1.4/summoner/by-name/${this.state.summoner}?api_key=RGAPI-88ae0def-8e60-4e5e-8e0e-998412963d34`, {}).done((data)=>{
      ...
      console.log(currentSummonerState)
      console.log(this.state.summonerSearchResults)
    })
  },
  saveLeagueResults() {
      ...
      <div>
        ...
        <div className="profile__accountSection">
          <div className="profile__accountLeagueHalf">
            <div className={this.state.leagueModal == false ? "leagueSearchReturn" : "leagueSearchReturn leagueSearchReturn--show"}>
            ...
            <button className={this.state.editProfile === false ? "editProfile__leagueUnlink" : "editProfile__leagueUnlink editProfile__leagueUnlink--show"} onClick={this.unlinkLeagueAccount}>unlink account</button>
