      ...
      <div>
        ...
        <div className="profile__accountXboxSection">
          <div className={this.state.xboxModal == false ? "searchReturnModal" : "searchReturnModal searchReturnModal--show"}>
            <h2>Is this your xbox account?</h2>
            <button onClick={this.closeXboxResults}>x</button>
            <ul>
              <li><img src={xboxSearchResult.GameDisplayPicRaw} alt="gamer pic"/></li>
              <li>{xboxSearchResult.Gamertag}</li>
            </ul>
            <button onClick={this.saveXboxResults}>save</button>
          </div>
