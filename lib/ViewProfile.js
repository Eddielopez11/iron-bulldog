      ...
      <div>
        ...
        <div className="profile__accountSection">
          ...
          <div className="profile__accountWowHalf">
            ...
            <div>
              <div>
                <img className="profile__wowCharacterImg" src={`https://render-api-us.worldofwarcraft.com/static-render/us/${wowCharacterState.thumbnail}`} alt={wowCharacterState.name}/>
                <ul className="profile__accountInfoList">
